      ...
      <Card className="page-frame w-full bg-transparent">
        <CardContent className="flex flex-col items-center gap-4 py-12 text-center">
          ...
          <div className="space-y-2">
            <p className="section-label">Builder error</p>
            <h2 className="font-display text-3xl font-semibold tracking-tight">
              The prompt builder did not load correctly
            </h2>
            <p className="text-muted-foreground mx-auto max-w-xl text-sm leading-6">
              Refresh the builder workspace and try again. If the problem keeps
              happening, the state of this page gives us a clear place to debug
              next.
            </p>
          </div>
